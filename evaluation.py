...
model = tf.keras.models.load_model("model MobileNet sem DA.h5", custom_objects={'KerasLayer':hub.KerasLayer, 'macro_f1': macro_f1, 'macro_soft_f1': macro_soft_f1})
...
for img, label in test_data:
    ...
    for i in range(5):
        print(prediction[i])
        tf.keras.utils.save_img(f"img{i+1}.png", img[i])
    break