...
DATA_PATH = "compiled_data/compiled_pokemon_data.csv"
CLASSES = 18
...
LR = 1e-5 # Learning rate. Keep it small when transfer learning
EPOCHS = 60
...
model.evaluate(create_dataset(X_test, y_test))

model.save("modelTDS.h5")
